...
CVT_SPEC = {
    'cvt-cifar-custom': {
        'INIT': 'trunc_norm',
        'NUM_STAGES': 3,
        'PATCH_SIZE': [3, 2, 2],  # Adjusted for CIFAR-100's 32x32 images
        'PATCH_STRIDE': [2, 2, 2], # Adjusted for better feature extraction
        'PATCH_PADDING': [1, 0, 0], # CORRECTED PADDING
        'DIM_EMBED': [64, 192, 384],  # CvT-13 like embed dimensions
        'NUM_HEADS': [1, 3, 6],      # CvT-13 like number of heads
        'DEPTH': [1, 2, 10],         # CvT-13 like depth
        ...
        'WITH_CLS_TOKEN': [False, False, True], # Only use CLS token in final stage
        'QKV_BIAS': True,
        'DROP_RATE': 0.1,
        'ATTN_DROP_RATE': 0.1,
        'DROP_PATH_RATE': 0.1,
        'INPUT_SIZE_STAGE': [32, 16, 8] # Adjusted for new patch sizes and strides
    }
}
